      ...
      <main className="max-w-2xl mx-auto px-4 pt-8 pb-12">
        ...
        <div className="text-center mb-7">
          ...
          <p className="text-gray-700 text-base leading-relaxed max-w-md mx-auto">
            Įklijuokite ją čia prieš spaudžiant nuorodą ar mokant pinigus.
          </p>
          <p className="text-gray-500 text-xs leading-relaxed max-w-md mx-auto mt-2.5">
            Demo versija įvertins rizikos požymius, parodys ko nedaryti ir ką tikrinti toliau.
          </p>
        </div>
        ...
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-2">
          {[
            { icon: '⚡', label: 'Rezultatas per ~30 sek.' },
            { icon: '🔒', label: 'Prototipe tekstas apdorojamas tik naršyklės sesijoje' },
            { icon: '🇱🇹', label: 'Lietuviškas demo' },
          ].map(({ icon, label }) => (
            <div
              key={label}
